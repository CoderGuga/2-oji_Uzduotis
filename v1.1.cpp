...
{
    try {
        string menu = "1 - ranka irasyti viska, 2 - generuoti pazymius, 3 - generuoti ir pazymius ir studentu vardus, pavardes, 4 - irasyti duomenis is failo, 5 - generuoti studentu failus, 6 - ruosiuoti sugeneruotus studentu failus, 7 - visu konteineriu testavimas, 8 - greitas testas, 9 - baigti darba: ";

        int stCon = CheckInt(menu, 9);
